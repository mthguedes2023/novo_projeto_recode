...
public class UsuarioDAO {
	...
	// create
		public void create(Usuarios usuario) {
			...
			String sql = "insert into Usuarios (nome_usuario, email, cpf) values (?, ?, ?)";
		...
		public List<Usuarios> read() {
			...
			try {
				...
				while (rset.next()) {
					...
					usuario.setId(rset.getInt("id_usuarios"));
		...
		public void update(Usuarios usuario) {
			String sql = "UPDATE Usuarios SET nome_usuario = ?, email = ?, cpf = ? WHERE id_usuarios = ?";
